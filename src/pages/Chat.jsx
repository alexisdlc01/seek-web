...
const conversations = [
	{
		...
		initials: "ES",
		messages: [
			{ from: "them", text: "Hi, is the contract ready?" },
			{ from: "me", text: "Yes! I’ll send it later today." },
		],
	},
	{
		id: 2,
		...
		initials: "JM",
		messages: [
			{ from: "them", text: "Can we move in earlier?" },
			{ from: "me", text: "I'll check with the landlord." },
		],
	},
];
...
export default function ChatPage() {
	...
	return (
		<div className="min-h-screen flex bg-gray-50 text-[var(--text-color)]">
			{/* Left Panel */}
			<div className="w-1/3 bg-blue-100 border-r border-gray-200 p-4 space-y-4">
				<h2 className="text-lg font-semibold text-blue-900">Applicants</h2>
				{conversations.map((c) => (
					<div
						key={c.id}
