		...
		<div className="space-y-2">
			...
			<div className="md:hidden flex gap-3 overflow-x-auto snap-x snap-mandatory -mx-1 px-1 pb-1">
				{items.map((s, i) => (
					<div
						key={i}
						className="min-w-[85%] snap-center rounded-xl border border-[var(--surface-border)] p-4 shadow-sm flex flex-col justify-between"
						style={{ background: "var(--gray-62)" }}
					>
						<div>
							<p className="text-sm font-semibold text-[var(--text-color)]">
...
export default function Dashboard() {
	...
	return (
		...
		>
			{/* ===================== DESKTOP (unchanged) ===================== */}
			<div className="hidden md:block px-6 lg:px-8 py-6">
				<div className="max-w-7xl mx-auto space-y-6">
					...
					<div className="grid gap-6 md:grid-cols-12">
						...
						<aside className="md:col-span-3">
							<div
								className="rounded-2xl p-6 border border-[var(--surface-border)]"
								style={{ background: "var(--gray-62)" }}
							>
								...
								<p className="mt-3 text-sm leading-6 text-[var(white)]">
									...
									data-driven view of the market to sharpen
			...
			<div className="md:hidden px-4 py-5">
				...
				>
					...
					<p className="mt-3 text-sm leading-6 text-[var(white)]">
						SEEKPerformance takes you beyond your portfolio’s limits
						with a comprehensive, data-driven view of the market to
